 ...
 * subscription and describe in prose what it should drive ("`agent.state.document`
 * is just a string that grows on every token", "`agent.isRunning` tells you
 * whether to show a streaming indicator"). This is that, minimally: the
 * document text, and a badge driven by `isRunning`. It is repo code, not the
 * doc's — see README §9.15.
 */
