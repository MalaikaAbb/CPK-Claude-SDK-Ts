...
export const PAGES = definePages([
  {
    ...
    extraTabs: [
      ...
      { filePath: "backend/src/agent-server.ts", startLine: 27, endLine: 31 },
    ],
  ...
  },
  {
    ...
    startLine: 36,
    endLine: 61,
    prompt: "Ask the user to pick a time slot for a call.",
    waitAfterPromptMs: 4000,
  },
  {
  ...
  },
  {
    ...
    startLine: 22,
    endLine: 132,
    prompt: "Replace the notes array in shared state with the full updated list.",
    waitAfterPromptMs: 4000,
  },
  {
