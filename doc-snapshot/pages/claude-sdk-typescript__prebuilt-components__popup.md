...
use [CopilotSidebar](/claude-sdk-typescript/prebuilt-components/sidebar). For a fully embedded
chat pane, use [`<CopilotChat>`](/claude-sdk-typescript/prebuilt-components/chat) directly.
...
| `header` | Slot for the popup header bar — see the [slot system](/claude-sdk-typescript/custom-look-and-feel/slots). |
...
[custom look and feel](/claude-sdk-typescript/custom-look-and-feel/slots) for the full slot
reference.
