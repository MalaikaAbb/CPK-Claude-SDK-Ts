...
See the [`useInterrupt` deep dive](/claude-sdk-typescript/human-in-the-loop/useInterrupt) for
...
[headless interrupts guide](/claude-sdk-typescript/human-in-the-loop/headless) — it shows
