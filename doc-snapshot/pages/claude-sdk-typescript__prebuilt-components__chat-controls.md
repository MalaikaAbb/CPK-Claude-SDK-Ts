...
- [CopilotPopup](/claude-sdk-typescript/prebuilt-components/popup) and [CopilotSidebar](/claude-sdk-typescript/prebuilt-components/sidebar): the prebuilt surfaces that own modal state.
...
- [Slots](/claude-sdk-typescript/custom-look-and-feel/slots): the `messageView` / `assistantMessage` slot system used above.
- [Programmatic Control](/claude-sdk-typescript/programmatic-control): driving agent runs from code without a chat UI.
