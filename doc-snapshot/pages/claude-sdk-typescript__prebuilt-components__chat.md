...
For a collapsible docked chat, use [CopilotSidebar](/claude-sdk-typescript/prebuilt-components/sidebar).
For a floating bubble that overlays content, use [CopilotPopup](/claude-sdk-typescript/prebuilt-components/popup).
For saved conversations and switching between prior conversations, drop in the [Threads Drawer](/claude-sdk-typescript/prebuilt-components/copilot-threads-drawer) (or go headless with [Headless Threads](/claude-sdk-typescript/headless-threads)).
...
| `messageView` | Slot for the message list — see [slots](/claude-sdk-typescript/custom-look-and-feel/slots). |
...
- **CSS variables / class overrides** — see [CSS customization](/claude-sdk-typescript/custom-look-and-feel/css)
- **Slots (subcomponents)** — see [slots](/claude-sdk-typescript/custom-look-and-feel/slots)
- **Fully headless** — see [headless UI](/claude-sdk-typescript/custom-look-and-feel/headless-ui)
