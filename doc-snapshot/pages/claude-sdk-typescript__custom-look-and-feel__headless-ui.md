...
- The [slot system](/claude-sdk-typescript/custom-look-and-feel/slots) isn't enough: you need a completely different layout.
...
- [Slots](/claude-sdk-typescript/custom-look-and-feel/slots) — less work than going fully headless, often enough.
- [CSS customization](/claude-sdk-typescript/custom-look-and-feel/css) — when you just need to re-skin the defaults.
